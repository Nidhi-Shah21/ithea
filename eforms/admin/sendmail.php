...
if(isset($_POST)){
   ...
   $_sql = "INSERT INTO mail_data(`email`,`name`,`link1`,`token1`,`link2`,`token2`,`link3`,`token3`,`link_expiry`,`phone`,`phone_otp`,`phone_otp2`,`is_phone_otp_sent`,`is_phone_otp2_sent`) VALUES(:email,:name, :link1, :token1, :link2, :token2, :link3, :token3, :link_expiry, :phone, :phone_otp, :phone_otp2, :is_phone_otp_sent, :is_phone_otp2_sent)";
