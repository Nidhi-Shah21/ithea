...
<body class="">
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                ...
                <div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed "
                    ...
                    <div class="" id="kt_header_menu_wrapper">
                        <a href="#">
                            <img alt="Logo" src="template/assets/media/logos/logo.jpg"
                                style="width: 90px;margin-left: 17px;" />
                        </a>
                    </div>
                    <!-- end:: Header Menu -->
                        ...
                        <div class="kt-portlet kt-portlet--mobile">
                            <div class="kt-portlet__head kt-portlet__head--lg">
                                ...
                                <div class="kt-portlet__head-toolbar">
                                    ...
                                    <button type="button" class="btn btn-bold btn-brand btn-sm" data-toggle="modal"
                                        data-target="#kt_modal_5">Send New Links</button>
                                </div>
                ...
                <div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-footer__copyright">
                            <?php echo Date('Y'); ?>&nbsp;&copy;&nbsp;<a href="#" target="_blank"
                                class="kt-link">Ithea</a>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="kt-checkbox-list">
                                <label class="kt-checkbox kt-checkbox--tick kt-checkbox--success">
                                    <input type="checkbox" name="link1" id="link1" value='1' checked="checked">
                                    ELIGIBILITY FORM
                                    <span></span>
                                </label>
                            </div>
                            <div class="kt-checkbox-list">
                                <label class="kt-checkbox kt-checkbox--tick kt-checkbox--success">
                                    <input type="checkbox" name="link2" id="link2" value='1' checked="checked">
                                    PRE-TRAINING FORM
                                    <span></span>
                                </label>
                            </div>
                            <div class="kt-checkbox-list">
                                <label class="kt-checkbox kt-checkbox--tick kt-checkbox--success">
                                    <input type="checkbox" name="link3" id="link3" value='1' checked="checked">
                                    PRE-TRAINING TRADE FORM
                                    <span></span>
                                </label>
                            </div>
    ...
    <script>
        $(document).on("submit", "#form_send_mail", function (e) {
            ...
            if (!$("#link1").is(':checked') && !$("#link2").is(':checked')) {
