...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            * { -webkit-box-sizing:border-box; -moz-box-sizing:border-box; -ms-box-sizing:border-box; -o-box-sizing:border-box; box-sizing:border-box; font-family: 'Poppins', sans-serif;}
            ...
            .toast-bottom-center{top: 15%!important;}
        </style>
    </head>
    ...
    <body class="">
        ...
        <div class="login">
            <h1>Ithea Login</h1>
            <form class="kt-form" action="index.php" method="POST" novalidate="novalidate" id="login-form">
                ...
                <button id="kt_login_signin_submit" type="submit" class="btn btn-primary btn-block btn-large">Sign In</button>
            </form>
        </div>
