...
<html lang="en-au" xml:lang="en-au" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title>
            ...
            ITHEA PRE-TRAINING INTERVIEW GENERAL - V23.2 - 23.03.2020
    ...
    <body style="max-width:1024px; width:100%; margin: 0 auto; padding:20px;">
        ...
        <table cellspacing="0" style="border-collapse:collapse;width: 100%;">
            ...
            <tr style="height:29pt">
                ...
                <td bgcolor="#3975C4" colspan="4" style="width:537pt;border-bottom-style:solid;border-bottom-width:1pt;border-bottom-color:#7E7E7E">

                    <p class="s4" style="padding-left: 5pt;text-indent: 0pt;line-height: 27pt;text-align: left;">

                        PRE-TRAINING INTERVIEW FORM
