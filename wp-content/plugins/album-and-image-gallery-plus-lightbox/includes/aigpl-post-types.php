...
function aigpl_register_post_type() {
	...
	$aigpl_post_lbls = apply_filters( 'aigpl_post_labels', array(
								...
								'featured_image'			=> __( 'Slide Image', 'album-and-image-gallery-plus-lightbox' ),
								'set_featured_image'		=> __( 'Set slide image', 'album-and-image-gallery-plus-lightbox' ),
								'remove_featured_image'		=> __( 'Remove slide image', 'album-and-image-gallery-plus-lightbox' ),
								'use_featured_image'		=> __( 'Use as slide image', 'album-and-image-gallery-plus-lightbox' ),
